...
<br>
            ...
            <br>
             ...
             <p> Since the game was action based <a href="https://soundcloud.com/mannymarx/bgm">I wrote a looping upbeat song</a> that had an array of different sounding organs to give it a vampire / Halloween vibe. The SFX were made with <a href="https://www.youtube.com/watch?v=jeufAYD5g3g">Logic's EMF1</a> as well as sampled sounds I made on site. I wanted to implement FMOD and a trill sound when the player got close to a vampire hunter but I lacked the knowledge on how to script it in Unity and didn't have the time to learn. So I decided to make a commercial for the game using some menu music I created.</p>
             <div align="center">
